...
<a href="https://pexek.com">
    <img src=".github/logo.svg" height="80" alt="PEXEK CRM Logo">
</a>

<h1>PEXEK CRM</h1>

**The internal customer pipeline for the PEXEK team**

[Production deployment](DEPLOYMENT.md) · [PEXEK website](https://pexek.com) · [Upstream documentation](https://docs.frappe.io/crm)
...
PEXEK CRM is the team's branded, self-hostable CRM. It supports team invitations,
role-based access, lead and deal pipelines, activities, email, WhatsApp and
calling integrations, dashboards, and custom workflows.

This project is based on the open-source [Frappe CRM](https://github.com/frappe/crm)
