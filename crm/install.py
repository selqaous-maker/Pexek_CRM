...
def add_pexek_brand_defaults():
	"""Apply PEXEK's name on new sites without overwriting later admin changes."""
	if not frappe.db.get_single_value("FCRM Settings", "brand_name"):
